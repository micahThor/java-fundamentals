...
public class TestRestaurant {
    ...
    @Test public void restaurant_testGetRestaurantName() {

        String expected = "Taco Bell";
        String actual = tacoBell.getRestaurantName();
    ...
    @Test public void restaurant_testToString() {
        ...
        String expected = "Name: Taco Bell :: Price Category: $$ :: Star Ranking: 2.8";
